  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
        ...
        <View style={[styles.headerWrap, { paddingTop: 56, paddingLeft: 56, paddingRight: 16 }]}>
          <Text style={styles.title} numberOfLines={2} ellipsizeMode="tail">
            {title}
          </Text>
          {!!drink?.strCategory && <Text style={styles.subtitle}>{drink.strCategory}</Text>}
          ...
          {!!err && !loading && (
            <View style={styles.infoBox}>
              ...
              <Text style={styles.infoTextSmall}>
                Tip: The API may be rate-limited. Pull to refresh, or try again in a moment.
              </Text>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  infoBox: { marginTop: 12, padding: 12, borderRadius: 8, backgroundColor: Colors.cardBackground ?? "#1A1921" },
