  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        const detail =
          j?.detail && typeof j.detail === "string" ? j.detail : "Invalid or expired code";
...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: "bold", fontSize: 24, marginBottom: 8, color: Colors.textPrimary, textAlign: "center" },
  subtitle: { fontSize: 14, color: Colors.textSecondary, textAlign: "center", marginBottom: 16 },
  row: { flexDirection: "row", gap: 10, marginBottom: 20 },
  box: {
    width: BOX_SIZE, height: BOX_SIZE, borderRadius: 10,
