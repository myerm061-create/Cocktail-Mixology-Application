...
def send_verification_email(to: str, verify_url: str) -> None:
    ...
    <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;">
      ...
      <p><a href="{verify_url}" style="background:#111;color:#fff;padding:10px 16px;border-radius:8px;text-decoration:none;border-radius:8px;">Verify Email</a></p>
      <p>If the button doesn’t work, paste this link in your browser:<br>{verify_url}</p>
    </div>
    """
...
def send_login_link(to: str, login_url: str) -> None:
    ...
    <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;">
      ...
      <p><a href="{login_url}" style="background:#111;color:#fff;padding:10px 16px;border-radius:8px;text-decoration:none;">Sign in</a></p>
      <p>If the button doesn’t work, paste this link in your browser:<br>{login_url}</p>
...
def send_password_reset(to: str, reset_url: str) -> None:
    ...
    <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;">
      ...
      <p>You requested a password reset. Click the button to choose a new password. This link expires soon.</p>
      <p><a href="{reset_url}" style="background:#111;color:#fff;padding:10px 16px;border-radius:8px;text-decoration:none;">Reset Password</a></p>
      <p>If the button doesn’t work, paste this link in your browser:<br>{reset_url}</p>
      <p style="color:#666;font-size:12px;margin-top:16px;">If you didn’t request this, you can safely ignore this email.</p>
    </div>
    """
    text = f"Reset your MyCabinet password: {reset_url}\nIf you didn’t request this, ignore this email."
    send_email(to, subject, html, text)
